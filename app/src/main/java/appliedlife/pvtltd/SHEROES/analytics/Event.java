...
public enum Event {
    ...
    PROFILE_SHARED(AnalyticsEventType.PROFILE, "Profile Shared"),
    ...
    PROFILE_POST_COUNT(AnalyticsEventType.PROFILE, "Post Count Click"),
    PROFILE_EDIT(AnalyticsEventType.PROFILE, "Profile Edited"),
    PROFILE_PIC_EDIT(AnalyticsEventType.PROFILE, "Profile Picture Edited"),
    PROFILE_FOLLOWER_COUNT(AnalyticsEventType.PROFILE, "Followers Count Click"),
    PROFILE_FOLLOWING_COUNT(AnalyticsEventType.PROFILE, "Following Count Click"),
    PROFILE_EMPTY_VIEW_JOIN_COMMUNITY(AnalyticsEventType.PROFILE, "Join Community"),
    PROFILE_EMPTY_VIEW_FOLLOW_CHAMPION(AnalyticsEventType.PROFILE, "Champion Listing"),
    PROFILE_COMMUNITY_VIEW_MORE(AnalyticsEventType.PROFILE, "Community View More click"),
    PROFILE_CHAMPION_VIEW_MORE(AnalyticsEventType.PROFILE, "Champion View More click"),
    //region Image related events
