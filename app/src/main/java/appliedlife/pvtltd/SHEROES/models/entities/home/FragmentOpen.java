...
public class FragmentOpen implements Parcelable{
    ...
    public void setProfileWorkExpEditFragment(boolean profileWorkExpEditFragment) {
        isProfileWorkExpEditFragment = profileWorkExpEditFragment;
    }

    public boolean isWorkExpFragment() {
        return isWorkExpFragment;
    }
    ...
    public boolean isHelplineFragment() {
        return isHelplineFragment;
    }

    public void setHelplineFragment(boolean isHelplineFragment) {
        this.isHelplineFragment = isHelplineFragment;
    }

    public boolean isSignupFragment() {
        return isSignupFragment;
    }

    public void setSignupFragment(boolean signupFragment) {
