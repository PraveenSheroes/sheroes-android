...
/**
 * Created by SHEROES-TECH on 30-01-2017.
 */

public class ShareCommunityActivity extends BaseActivity implements ShareCommunityFragment.ShareCommunityActivityIntractionListner, BaseHolderInterface, CustiomActionBarToggle.DrawerStateListener, NavigationView.OnNavigationItemSelectedListener{
    String data="";
    @Override
    ...
    public void renderLoginFragmentView() {
        ...
        ShareCommunityFragment frag = new ShareCommunityFragment(data);
