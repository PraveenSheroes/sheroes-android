...
public class ProfileSchoolDialog extends BaseDialogFragment implements OnBoardingView {
    private final String TAG = LogUtils.makeLogTag(ProfileSchoolDialog.class);
    @Inject
    AppUtils mAppUtils;
