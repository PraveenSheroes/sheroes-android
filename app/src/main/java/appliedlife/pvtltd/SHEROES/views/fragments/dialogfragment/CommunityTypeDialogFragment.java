...
public class CommunityTypeDialogFragment extends BaseDialogFragment implements CommunityView, CommunityTypeAdapter.CommunityTypeAdapterCallback, HomeView {
    @Inject
    ...
    private final String TAG = LogUtils.makeLogTag(CommunityTypeDialogFragment.class);
