...
public class WelcomeScreen2Fragment extends BaseFragment {

    private final String TAG = LogUtils.makeLogTag(WelcomeFragment.class);
    private final String SCREEN_NAME = "WelcomeScreen2Fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_welcome_screen2, container, false);
