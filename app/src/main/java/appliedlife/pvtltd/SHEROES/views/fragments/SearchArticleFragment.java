...
public class SearchArticleFragment extends BaseFragment implements HomeView {
    private static final String SCREEN_LABEL = "Search Article Screen";
    private final String TAG = LogUtils.makeLogTag(SearchArticleFragment.class);
    @Inject
    ...
    Runnable mFilterTask = new Runnable()
    {
        ...
        public void run()
        {
            if (!isDetached())
            {
                ...
                mHomePresenter.getFeedFromPresenter(mAppUtils.searchRequestBuilder(AppConstants.FEED_ARTICLE,mSearchDataName ,mFragmentListRefreshData.getPageNo(),AppConstants.ALL_SEARCH,null,AppConstants.PAGE_SIZE));
            }
        }
    };
