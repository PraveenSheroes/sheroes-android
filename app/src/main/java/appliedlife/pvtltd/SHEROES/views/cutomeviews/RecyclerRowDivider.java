...
/**
 * Created by ravi on 13/01/18.
 */

public class RecyclerRowDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public RecyclerRowDivider(@NonNull Context context, @ColorInt int color,
