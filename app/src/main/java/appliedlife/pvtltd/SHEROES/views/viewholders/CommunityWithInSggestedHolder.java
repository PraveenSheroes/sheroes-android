...
public class CommunityWithInSggestedHolder extends BaseViewHolder<CommunitySuggestion> {
    private final String TAG = LogUtils.makeLogTag(CommunityWithInSggestedHolder.class);
    ...
    public CommunityWithInSggestedHolder(View itemView, BaseHolderInterface baseHolderInterface) {
        super(itemView);
