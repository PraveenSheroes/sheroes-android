...
public class ProfileSearchLanguageDialogFragment extends BaseDialogFragment implements OnBoardingView {
    private final String TAG = LogUtils.makeLogTag(ProfileSearchLanguageDialogFragment.class);
    @Inject
    AppUtils mAppUtils;
