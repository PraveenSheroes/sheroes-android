 ...
 * @version 5.0
 * @since 29/12/2016
 * Title: Ripple view for list item click.
 */
...
public class RippleView extends RelativeLayout
{
    ...
    private void init(final Context context, final AttributeSet attrs)
    {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, getResources().getColor(R.color.colorPrimaryDark));
    ...
    /**
     * Method that draw requirement on canavas.
     *
     * @param canvas Canvas in which draw
     */
    @Override
