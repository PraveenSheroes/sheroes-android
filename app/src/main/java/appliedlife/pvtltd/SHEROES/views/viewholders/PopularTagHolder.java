...
public class PopularTagHolder extends BaseViewHolder<PopularTag> {
    private final String TAG = LogUtils.makeLogTag(OnBoardingHolder.class);
    BaseHolderInterface viewInterface;
    @Bind(R.id.li_community_tags)
    LinearLayout liTags;
    @Bind(R.id.tv_community_tag_header)
    TextView tvTagHeader;
    private PopularTag dataItem;
    ...
    public PopularTagHolder(View itemView, BaseHolderInterface baseHolderInterface) {
        super(itemView);
    ...
    @Override
    public void bindData(PopularTag obj, Context context, int position) {
        dataItem = obj;
        mContext = context;
    ...
    private void inflateTagData(LinearLayout liRow, List<String> stringList) {
        ...
        LinearLayout liTagLable = (LinearLayout) columnInflate.inflate(R.layout.tag_item_for_community, null);
        final TextView mTvTagData = (TextView) liTagLable.findViewById(R.id.tv_community_tag_data);
        ...
        mTvTagData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mTvTagData.setBackgroundResource(R.drawable.select_inivite_button_added_color);
