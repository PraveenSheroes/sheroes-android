...
package appliedlife.pvtltd.SHEROES.views.cutomeviews.materialspinner;
...
public class MaterialSpinner extends TextView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    left = right = bottom = top = resources.getDimensionPixelSize(R.dimen.dp_size_16);
    if (rtl) {
      right = resources.getDimensionPixelSize(R.dimen.dp_size_20);
    } else {
      left = resources.getDimensionPixelSize(R.dimen.dp_size_20);
    }
    ...
    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Object item = adapter.getItemId(position);
