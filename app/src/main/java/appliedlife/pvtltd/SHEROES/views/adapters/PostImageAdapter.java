...
public class PostImageAdapter extends RecyclerView.Adapter<PhotoViewHolder> {
    ...
    //region Constructor
    public PostImageAdapter(Context context, List<Photo> photos, View.OnClickListener onClickListener) {
