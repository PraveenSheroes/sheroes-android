...
public class MentorInsightActivity extends BaseActivity implements MentorView {
    ...
    private void mentorInsightDetail(MentorInsightResponse mentorInsightResponse) {
        ...
        if (mUserSolrObj.getSolrIgnoreNoOfMentorFollowers() > 0) {
            ...
            tvMentorInsightFollowerCount.setText(String.valueOf(beautifyNumericValue(mUserSolrObj.getSolrIgnoreNoOfMentorFollowers())));
        ...
        if (mentorInsightResponse.getTotalNoOfImpressions() > 0) {
            ...
            tvImpressionCount.setText(String.valueOf(beautifyNumericValue(mentorInsightResponse.getTotalNoOfImpressions())));
        ...
        if (mUserSolrObj.getSolrIgnoreNoOfMentorPosts() > 0) {
            ...
            tvMentorInsightPostCount.setText(String.valueOf(beautifyNumericValue(mUserSolrObj.getSolrIgnoreNoOfMentorPosts())));
        ...
        if (mentorInsightResponse.getTotalNoOfLikes() > 0) {
            ...
            tvInsightLikeCount.setText(String.valueOf(beautifyNumericValue(mentorInsightResponse.getTotalNoOfLikes())));
        ...
        if (mentorInsightResponse.getTotalNoOfCommentsOnUserPost() > 0) {
            ...
            tvInsightComentCount.setText(String.valueOf(beautifyNumericValue(mentorInsightResponse.getTotalNoOfCommentsOnUserPost())));
        ...
        if (mentorInsightResponse.getTotalNoOfQuestions() > 0) {
            ...
            tvMentorInsightQuestionCount.setText(String.valueOf(beautifyNumericValue(mentorInsightResponse.getTotalNoOfCommentsOnUserPost())));
        ...
        if (mUserSolrObj.getSolrIgnoreNoOfMentorAnswers() > 0) {
            ...
            tvMentorInsightAnswerCount.setText(String.valueOf(beautifyNumericValue(mUserSolrObj.getSolrIgnoreNoOfMentorAnswers())));
