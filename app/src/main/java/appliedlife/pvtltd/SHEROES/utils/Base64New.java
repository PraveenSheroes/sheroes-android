...
public class Base64New {
	...
	public static void encode(java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded) {
		...
		while (raw.hasRemaining()) {
			...
			raw.get(raw3, 0, rem);
			Base64New.encode3to4(enc4, raw3, rem, Base64New.NO_OPTIONS);
			encoded.put(enc4);
		} // end input remaining
	}
	 ...
	 *            Specified options
	 * @return The Base64-encoded object
	 * @see com.mmt.travel.app.common.util.Base64New#GZIP
	 * @see com.mmt.travel.app.common.util.Base64New#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.0
	 */
	...
	public static byte[] encodeBytesToBytes(byte[] source) {
		byte[] encoded = null;
		try {
			encoded = encodeBytesToBytes(source, 0, source.length, Base64New.NO_OPTIONS);
		} catch (java.io.IOException ex) {
	...
	public static byte[] decode(byte[] source) throws java.io.IOException {
		byte[] decoded = null;
		// try {
		decoded = decode(source, 0, source.length, Base64New.NO_OPTIONS);
		// } catch( java.io.IOException ex ) {
		// assert false :
	...
	public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
		...
		try {
			bos = new OutputStream(new java.io.FileOutputStream(filename), Base64New.ENCODE);
	...
	public static void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
		...
		OutputStream bos = null;
		try {
			bos = new OutputStream(new java.io.FileOutputStream(filename), Base64New.DECODE);
	...
	public static String encodeFromFile(String filename) throws java.io.IOException {
		...
		try {
			...
			// Save in a variable to return
			encodedData = new String(buffer, 0, length, Base64New.PREFERRED_ENCODING);
	...
	public static void encodeFileToFile(String infile, String outfile) throws java.io.IOException {
		...
		String encoded = Base64New.encodeFromFile(infile);
	...
	public static void decodeFileToFile(String infile, String outfile) throws java.io.IOException {
		...
		byte[] decoded = Base64New.decodeFromFile(infile);
		java.io.OutputStream out = null;
		try {
			out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
			out.write(decoded);
	...
	/**
	 * A {@link com.mmt.travel.app.common.util.Base64New.InputStream} will read data from another
	 * <tt>java.io.InputStream</tt>, given in the constructor, and encode/decode
	 * to/from Base64 notation on the fly.
	 *
	 * @see com.mmt.travel.app.common.util.Base64New
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link com.mmt.travel.app.common.util.Base64New.InputStream} in DECODE mode.
		 *
		 * @param in
		...
		/**
		 * Constructs a {@link com.mmt.travel.app.common.util.Base64New.InputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 *
		 ...
		 * @param options
		 *            Specified options
		 * @see com.mmt.travel.app.common.util.Base64New#ENCODE
		 * @see com.mmt.travel.app.common.util.Base64New#DECODE
		 * @see com.mmt.travel.app.common.util.Base64New#DO_BREAK_LINES
		 * @since 2.0
		 */
	...
	/**
	 * A {@link com.mmt.travel.app.common.util.Base64New.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link com.mmt.travel.app.common.util.Base64New.OutputStream} in ENCODE mode.
		 *
		 * @param out
		...
		/**
		 * Constructs a {@link com.mmt.travel.app.common.util.Base64New.OutputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 *
			...
			// Else, Decoding
				...
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					if (position >= bufferLength) { // Enough to output.
						...
						int len = Base64New.decode4to3(buffer, 0, b4, 0, options);
						out.write(b4, 0, len);
						position = 0;
					} // end if: enough to output
