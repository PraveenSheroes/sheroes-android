 ...
 * Use {@link CropImage#activity(Uri,int)} to create a builder to start this activity.
 */
public class CropImageActivity extends BaseActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mImageSelectOptionPicker=bundle.getInt(CropImage.OPTION_TO_BE_OPEN);
        ...
        if (savedInstanceState == null) {
            if (mCropImageUri == null || mCropImageUri.equals(Uri.EMPTY)) {
                if (CropImage.isExplicitCameraPermissionRequired(this)) {
                    ...
                    CropImage.startPickImageActivity(this,mImageSelectOptionPicker);
                }
        ...
        if (actionBar != null) {
            CharSequence title = mOptions.activityTitle != null && mOptions.activityTitle.length() > 0
                    ...
                    : getResources().getString(R.string.ID_APP_NAME);
            actionBar.setTitle(title);
            actionBar.setDisplayHomeAsUpEnabled(true);
        }
        ((SheroesApplication) getApplication()).trackScreenView(getString(R.string.ID_CROP_IMAGE));
    }
    ...
    //endregion
    @OnClick(R.id.tv_crop_image)
    public void onSelectImageClick() {
        cropImage();
    }
    @OnClick(R.id.iv_image_crop_back)
    public void onImageCropBackClick() {
        onBackPressed();
    }
